    ...
    <main className={`pt-24 min-h-screen bg-gray-50 text-gray-900 overflow-y-auto transition-all duration-300 ${
      ...
      <div className="p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-gray-900">Depot</h1>
        ...
        <div className="bg-white rounded-lg p-8 text-center border border-gray-200 shadow-sm">
          ...
          <h2 className="text-2xl font-bold mb-4 text-gray-900">Depot Management</h2>
          <p className="text-gray-600 mb-6">
            This section will contain depot management functionality including:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
              <h3 className="font-semibold mb-2 text-gray-900">⛽ Fuel Inventory</h3>
              <p className="text-sm text-gray-600">Monitor fuel stock levels</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
              <h3 className="font-semibold mb-2 text-gray-900">🏭 Operations</h3>
              <p className="text-sm text-gray-600">Manage depot operations</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
