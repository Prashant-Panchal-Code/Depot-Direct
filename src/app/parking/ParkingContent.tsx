    ...
    <main className="ml-64 pt-20 min-h-screen bg-gray-900 text-white overflow-y-auto">
      <div className="p-8">
        ...
        <div className="bg-gray-800 rounded-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold mb-4">Parking Management</h2>
          <p className="text-gray-400 mb-6">
            This section will contain parking management functionality including:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
            <div className="bg-gray-700/50 p-4 rounded-md">
              <h3 className="font-semibold mb-2">🚛 Truck Parking</h3>
              <p className="text-sm text-gray-400">Manage truck parking spaces</p>
            </div>
            <div className="bg-gray-700/50 p-4 rounded-md">
              <h3 className="font-semibold mb-2">📍 Space Allocation</h3>
              <p className="text-sm text-gray-400">Optimize parking assignments</p>
            </div>
            <div className="bg-gray-700/50 p-4 rounded-md">
              <h3 className="font-semibold mb-2">⏰ Time Management</h3>
              <p className="text-sm text-gray-400">Track parking duration</p>
            </div>
          </div>
        </div>
      </div>
